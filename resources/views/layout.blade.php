        ...
        <div class="container">
            <div class="row" id="headwrap">
                <div class="col-md-3 col-sm-6 slogan">
                    <p class="site-title"><a class="logo" href="{{route('homepage')}}" title="phim hay ">Phim Hay</a></p>
                </div>
            ...
            <nav class="navbar halim-navbar main-navigation" role="navigation" data-dropdown-hover="1">
                <div class="navbar-header">
                    ...
                    <button type="button" class="navbar-toggle collapsed pull-right get-locphim-on-mobile">
                        <a href="javascript:;" id="expand-ajax-filter" style="color: #ffed4d;">Lọc
                ...
                <div class="collapse navbar-collapse" id="halim">
                    <div class="menu-menu_1-container">
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            ...
                            <li class="mega"><a title="Phim Mới" href="{{url('category')}}">Phim Mới</a></li>
                            ...
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    <li><a title="Tâm Lý" href="{{url('genre')}}">Tâm Lý</a></li>
                                </ul>
                            </li>
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    <li><a title="Việt nam" href="{{url('country')}}">Việt nam</a></li>
                                </ul>
                            </li>
